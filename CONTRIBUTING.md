...
Welcome to `ultimate-notion` contributor's guide.
...
`ultimate-notion` documentation uses [Sphinx] as its main documentation compiler.
...
```
conda create -n ultimate-notion python=3 six virtualenv pytest pytest-cov
...
5. Install [pre-commit]:
   ...
   `ultimate-notion` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/ultimate-notion
[issue tracker]: https://github.com/<USERNAME>/ultimate-notion/issues
