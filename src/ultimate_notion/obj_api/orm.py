...
from ultimate_notion.obj_api.schema import PropertyObject, RichText
from ultimate_notion.obj_api.text import make_safe_python_name
from ultimate_notion.obj_api.types import DatabaseRef, EmojiObject, ExternalFile, PropertyValue
...
class ConnectedPage:
    ...
    def append(self, *blocks):
        ...
        logger.debug("appending %d blocks to page :: %s", len(blocks), self._notional__page.id)
